        ...
        if (aspect != null) {
            ...
            if (amount > 0.0F) {
                ...
                for(int var22 = 0; var22 < var21; ++var22) {
                    ...
                    mc.fontRenderer.drawString(am, (float)(32 - sw + (int)x * 2) * q + (float)e.getFrontOffsetX(), (float)(32 - mc.fontRenderer.FONT_HEIGHT + (int)y * 2) * q + (float)e.getFrontOffsetZ(), 0, false);
                }
