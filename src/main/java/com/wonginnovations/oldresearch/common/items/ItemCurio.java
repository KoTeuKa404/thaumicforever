...
public class ItemCurio extends Item {
    ...
    public @NotNull String getUnlocalizedName(ItemStack itemStack) {
        return super.getUnlocalizedName() + "." + OldResearchManager.CURIOS.get(itemStack.getMetadata()).getName().toLowerCase();
    }
