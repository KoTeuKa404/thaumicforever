...
import com.tutorialmod.turtywurty.ThaumicForever;
...
public class ModOreBlocks {
    ...
    public static void registerModels(ModelRegistryEvent event) {
        ...
        ThaumicForever.proxy.registerItemRenderer(Item.getItemFromBlock(SMOOTH_STONE), 0, "inventory"); // Реєстрація моделі для нового блоку
