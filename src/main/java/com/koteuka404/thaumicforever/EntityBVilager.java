...
public class EntityBVilager extends EntityZombieVillager {
    protected void applyEntityAttributes() {
        ...
        getEntityAttribute(EntityZombie.SPAWN_REINFORCEMENTS_CHANCE).setBaseValue(0.0);
    }

    public EntityBVilager(World world) {
        super(world);
