...
public class DoubleTableBlock extends Block {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (te instanceof DoubleTableTileEntity) {
            InventoryHelper.dropInventoryItems(worldIn, pos, (DoubleTableTileEntity) te);
        ...
        BlockPos invisiblePos = pos.offset(dir.rotateY());
        if (worldIn.getBlockState(invisiblePos).getBlock() instanceof InvisiblePartBlock) {
            InvisiblePartBlock.SKIP_MAIN_REMOVAL = true;
            try {
                worldIn.setBlockToAir(invisiblePos);
            } finally {
                InvisiblePartBlock.SKIP_MAIN_REMOVAL = false;
            }
        }
