...
public class UpdateIchor implements IWandUpdate {
    ...
    public void onUpdate(ItemStack stack, EntityPlayer player) {
        ...
        boolean empowered = !world.isDaytime() || world.provider.getDimension() == -1 || world.provider.getDimension() == 1;
        float targetCharge = empowered ? 0.90F : 0.75F;
        int recharge = empowered ? 2 : 1;
