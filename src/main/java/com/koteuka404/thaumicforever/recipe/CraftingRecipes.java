...
import com.koteuka404.thaumicforever.block.RubyBlock;
...
public class CraftingRecipes {
    public static void init() {
        GameRegistry.addShapedRecipe(
            new ResourceLocation("thaumicforever", "void_singularity_minecart"),
            null,
            new ItemStack(ModItems.VOID_SINGULARITY_MINECART),
            "M",
            "V",
            'M', Items.MINECART,
            'V', Item.getItemFromBlock(ModBlocks.VOID_SINGULARITY)
        );
...
// // // // // // // // // // // // // // // // // // // // // // // // // // // //       
        ...
        GameRegistry.addShapedRecipe(
            new ResourceLocation("thaumicforever", "greatwood_door"),
            null,
            new ItemStack(ModBlocks.DOOR_GREATWOOD_ITEM, 2),
            "LL",
            "LL",
            "LL",
            'L', new ItemStack(BlocksTC.plankGreatwood)
        );
        GameRegistry.addShapedRecipe(
            new ResourceLocation("thaumicforever", "silverwood_door"),
            null,
            new ItemStack(ModBlocks.DOOR_SILVERWOOD_ITEM, 2),
            "LL",
            "LL",
            "LL",
            'L', new ItemStack(BlocksTC.plankSilverwood)
        );
        GameRegistry.addShapedRecipe(
            new ResourceLocation("thaumicforever", "arcane_door"),
            null,
            new ItemStack(ModBlocks.DOOR_ARCANE_ITEM, 1),
            "III",
            "IDI",
            "III",
            'I', new ItemStack(ItemsTC.nuggets, 1, 6),
        ...
        GameRegistry.addShapedRecipe(
            ...
            null,
            new ItemStack(ModBlocks.TRAPDOOR_GREATWOOD,3),
            "LLL",
            "LLL",
            'L', new ItemStack(BlocksTC.plankGreatwood)
        );
        GameRegistry.addShapedRecipe(
            new ResourceLocation("thaumicforever", "silverwood_trapdoor"),
            null,
            new ItemStack(ModBlocks.TRAPDOOR_SILVERWOOD,3),
            "LLL",
            "LLL",
            'L', new ItemStack(BlocksTC.plankSilverwood)
        );
