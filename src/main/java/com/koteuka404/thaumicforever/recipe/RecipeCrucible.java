...
public class RecipeCrucible {
    ...
    public static void addCrucibleRecipes() {
        ...
        ResourceLocation cleanMindRecipeKey = new ResourceLocation(MODID, "clean_mind_recipe");
        CrucibleRecipe cleanMindRecipe = new CrucibleRecipe(
            "RESEARCHCLEANFT",
        ...
        ThaumcraftApi.addCrucibleRecipe(cleanMindRecipeKey, cleanMindRecipe);
