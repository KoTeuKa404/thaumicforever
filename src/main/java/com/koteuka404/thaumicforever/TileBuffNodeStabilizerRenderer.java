...
public class TileBuffNodeStabilizerRenderer extends TileEntitySpecialRenderer<TileBuffNodeStabilizer> {
    ...
    private static final ResourceLocation OVER = new ResourceLocation("thaumicforever", "textures/blocks/node_stabilizer_over_1.png");
    private static final ResourceLocation BUBBLE = new ResourceLocation("thaumicforever", "textures/misc/aura_lock.png");

    public void renderTileEntityAt(TileBuffNodeStabilizer tile, double par2, double par4, double par6, float par8) {
        int bright = 20;
    ...
    @Override
    public void render(TileBuffNodeStabilizer par1TileEntity, double par2, double par4, double par6, float par8, int q, float a) {
