...
public class DeconstructionTableGui extends GuiContainer {
    ...
    private static final int MAX_PROGRESS_HEIGHT = 46;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (tileEntity.isProcessing()) {
            ...
            this.drawTexturedModalRect(i + 93, j + 14 + (MAX_PROGRESS_HEIGHT - progress), 176, MAX_PROGRESS_HEIGHT - progress, 9, progress);
