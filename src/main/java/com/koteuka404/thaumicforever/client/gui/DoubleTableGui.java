...
public class DoubleTableGui extends GuiContainer {
    ...
    private static final ResourceLocation GREAT_TEXTURE = new ResourceLocation(ThaumicForever.MODID, "textures/gui/gui_great.png");
    ...
    public DoubleTableGui(InventoryPlayer playerInventory, IInventory tileEntity) {
        this(playerInventory, tileEntity, new DoubleTableContainer(playerInventory, tileEntity));
    }

    protected DoubleTableGui(InventoryPlayer playerInventory, IInventory tileEntity, Container container) {
        super(container);
    ...
    private ResourceLocation getGuiTexture() {
        if (this.tileEntity instanceof TileEntity) {
            ...
            if (tile.getWorld() != null) {
                ...
                if (block == ModBlocks.GREAT_RESEARCH_TABLE || block == ModBlocks.GREAT_RESEARCH_TABLE_SIDE) {
                    return GREAT_TEXTURE;
                }
            }
        }
        return TEXTURE;
