...
public class AuraCloudRenderer extends Render<AuraCloudEntity> {
    ...
    public AuraCloudRenderer(RenderManager renderManager) {
        super(renderManager);
    }

    @Override
    public boolean shouldRender(AuraCloudEntity entity, ICamera camera, double camX, double camY, double camZ) {
        EntityPlayer player = Minecraft.getMinecraft().player;
        return player != null && ItemAquareiaGoggles.shouldRenderHud(player);
    }

    @Override
    public void doRender(AuraCloudEntity entity, double x, double y, double z,
    ...
    @Override
    protected ResourceLocation getEntityTexture(AuraCloudEntity entity) {
