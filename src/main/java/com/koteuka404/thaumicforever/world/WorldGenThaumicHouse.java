...
public class WorldGenThaumicHouse implements IWorldGenerator {
    ...
    public static final ResourceLocation HOUSE_TRAP_LOOT_TABLE =
        new ResourceLocation("thaumicforever", "chests/house_trap");
    ...
    public static void registerLootTables() {
        ...
        if (!LootTableList.getAll().contains(HOUSE_TRAP_LOOT_TABLE)) {
            LootTableList.register(HOUSE_TRAP_LOOT_TABLE);
        }
    }
                ...
                for (int dz = 0; dz < size.getZ(); dz++) {
                    ...
                    if (world.getBlockState(pos).getBlock() instanceof BlockChest) {
                        ...
                        if (te instanceof TileEntityLockableLoot) {
                            ...
                            ResourceLocation table = world.getBlockState(pos).getBlock() == Blocks.TRAPPED_CHEST
                                ? HOUSE_TRAP_LOOT_TABLE
                                : HOUSE_LOOT_TABLE;
                            loot.setLootTable(table, random.nextLong());
