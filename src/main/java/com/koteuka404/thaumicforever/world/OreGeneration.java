package com.koteuka404.thaumicforever.world;
    ...
    public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, net.minecraft.world.chunk.IChunkProvider chunkProvider) {
        if (world.provider.getDimension() == 0) {
            ...
            if (ModConfig.enableAncientOreGeneration) {
                ...
                generateOre(ModOreBlocks.ANCIENT_COAL.getDefaultState(),     world, rand, chunkX, chunkZ, 8, 20, 4, 12, 1, Blocks.STONE.getDefaultState());
                generateOre(ModOreBlocks.ANCIENT_GOLD.getDefaultState(),     world, rand, chunkX, chunkZ, 8, 16, 4, 12, 1, Blocks.STONE.getDefaultState());
                generateOre(ModOreBlocks.ANCIENT_IRON.getDefaultState(),     world, rand, chunkX, chunkZ, 8, 20, 4, 12, 1, Blocks.STONE.getDefaultState());
            }
