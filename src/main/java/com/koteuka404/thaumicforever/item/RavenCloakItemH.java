...
import com.koteuka404.thaumicforever.client.model.RavenCloakModel;

public class RavenCloakItemH extends Item implements IBauble, IRenderBauble {
    ...
    public RavenCloakItemH() {
        setRegistryName("raven_cloak_bauble_head");
        setUnlocalizedName("raven_cloak_bauble_head");
