...
public class DarkCloakItem extends Item implements IBauble, IRenderBauble {
    ...
    public DarkCloakItem() {
        setRegistryName("dark_cloak_bauble");
        setUnlocalizedName("dark_cloak_bauble");
