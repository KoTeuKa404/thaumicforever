...
public class ModBlocks {
    ...
    public static final Block LEAD_BLOCK = new Block(Material.IRON)
        .setUnlocalizedName("lead_block")
        .setRegistryName("lead_block").setCreativeTab(ThaumicForever.CREATIVE_TAB);
        
    public static final Block SILVER_BLOCK = new Block(Material.IRON)
        .setUnlocalizedName("silver_block")
        .setRegistryName("silver_block").setCreativeTab(ThaumicForever.CREATIVE_TAB);
        
    public static final Block TIN_BLOCK = new Block(Material.IRON)
        .setUnlocalizedName("tin_block")
        .setRegistryName("tin_block").setCreativeTab(ThaumicForever.CREATIVE_TAB);
        
    public static final Block COPPER_BLOCK = new Block(Material.IRON)
        .setUnlocalizedName("copper_block")
        .setRegistryName("copper_block").setCreativeTab(ThaumicForever.CREATIVE_TAB);

    public static final Block OBSIDIAN_TOTEM = new Block(Material.IRON)
        .setUnlocalizedName("obsidian_totem")
        .setRegistryName("obsidian_totem").setCreativeTab(ThaumicForever.CREATIVE_TAB);
