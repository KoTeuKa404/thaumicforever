...
public class TileInvertedBuffNodeStabilizerRenderer extends TileEntitySpecialRenderer<TileInvertedBuffNodeStabilizer> {
    ...
    public void renderTileEntityAt(TileInvertedBuffNodeStabilizer tile, double par2, double par4, double par6, float par8) {
        int bright = 20;
    ...
    @Override
    public void render(TileInvertedBuffNodeStabilizer tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
