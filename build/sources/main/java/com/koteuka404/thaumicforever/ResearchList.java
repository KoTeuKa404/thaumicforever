...
public class ResearchList {
    ...
    // Жорстко закодований список досліджень
    ...
    // Список досліджень з конфігурації
    private static List<String> RESEARCHES = new ArrayList<>();

    /**
     * Ініціалізація списку досліджень із конфігурації та додавання жорстко закодованих
     */
    public static void initializeFromConfig() {
        // Перетворюємо масив із конфігурації в список
        RESEARCHES = new ArrayList<>(Arrays.asList(ModConfig.general.researchList));

        // Додаємо жорстко закодовані дослідження, якщо їх немає в конфігурації
